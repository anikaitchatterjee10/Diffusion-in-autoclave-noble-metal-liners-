...
The tool uses 3 diffusion coefficients for each element (Method 1, 2 and 3)
...
o	Scenario B: Used when literature is not available. Q is calculated via a theoretical estimation using Eq. 4, and D0 is determined through extrapolation using MNR (Eq. 6).
•	Method 2:
